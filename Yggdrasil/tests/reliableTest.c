...
#define RELIABLE_POINT2POINT_ID 101
...
int main(int argc, char* argv[]) {
	...
	addProtocol(RELIABLE_POINT2POINT_ID, reliable_point2point, NULL, 1);
	...
	queue_t* inter = interceptProtocolQueue(PROTO_DISPATCH, RELIABLE_POINT2POINT_ID);
	//	ft_attr fdattr;
	//	fdattr.intercept = inter;
	//	fdattr.timeout_failure_ms = 10000;
	updateProtoAttr(RELIABLE_POINT2POINT_ID, (void *) inter);
	//
	short ev[1];
	ev[0] = FAILED_DELIVERY;
	registInterestEvents(RELIABLE_POINT2POINT_ID,ev,1,myId);
