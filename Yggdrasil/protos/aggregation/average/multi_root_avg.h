...
#ifndef AGGREGATION_MULTI_ROOT_AVG_H_
#define AGGREGATION_MULTI_ROOT_AVG_H_
...
#include "protos/discovery/discovery_ft_lb.h" //EVENT:  DISCOV_FT_LB_NEIGH_DOWN

void* multi_root_avg_init(void* args);


#endif /* AGGREGATION_MULTI_ROOT_AVG_H_ */
